/* Generated by scripts/gen_nfc_table.py -- do not edit by hand.
 * Canonical composition pairs for U+00C0..U+024F (Latin-1 Supplement and
 * Latin Extended-A/B), built from Python's unicodedata. Covers the accented
 * forms that appear in Western address data. */
#ifndef DUCKDB_NFC_TABLE_H
#define DUCKDB_NFC_TABLE_H

typedef struct { unsigned int base, mark, composed; } pagc_nfc_pair;

static const pagc_nfc_pair pagc_nfc_pairs[] = {
...
#define PAGC_NFC_PAIR_COUNT 252

#endif /* DUCKDB_NFC_TABLE_H */
